...
import com.sgm.navi.ui.view.refresh.SettingHeadRefreshView;
import com.sgm.navi.ui.view.refresh.SettingLoadMoreView;
import com.sgm.navi.ui.view.refresh.State;

public class SettingPullToRefreshLayout extends SkinFrameLayout {

    private static final long ANIM_TIME = 250;
    private static int HEAD_HEIGHT = 80;
    ...
    public SettingPullToRefreshLayout(final Context context) {
        this(context, null);
    }

    public SettingPullToRefreshLayout(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SettingPullToRefreshLayout(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    ...
    private void addHeadView() {
        if (mHeaderView == null) {
            mHeaderView = new SettingHeadRefreshView(getContext());
        }
    ...
    private void addFooterView() {
        if (mFooterView == null) {
            mFooterView = new SettingLoadMoreView(getContext());
        }
        final LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 0);
