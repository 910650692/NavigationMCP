...
import com.sgm.navi.scene.databinding.ScenePoiDetailsReservationChargeDetailViewBinding;
import com.sgm.navi.scene.impl.poi.ScenePoiChargingStationReservationListViewImpl;
import com.sgm.navi.scene.ui.adapter.ChargeEquipmentListAdapter;
import com.sgm.navi.scene.ui.search.ChargeQrCodeDialog;
...
public class ScenePoiChargingStationReservationListView extends BaseSceneView<ScenePoiDetailsReservationChargeDetailViewBinding, ScenePoiChargingStationReservationListViewImpl> {
    ...
    private void initAdapter(){
        final int spacingInPixels = getResources().getDimensionPixelSize(com.sgm.navi.ui.R.dimen.dp_16);
