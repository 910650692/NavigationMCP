...
import com.sgm.navi.scene.databinding.SceneNaviTbtViewBinding;
import com.sgm.navi.scene.impl.navi.SceneNaviTbtImpl;
...
public class SceneNaviTbtView extends NaviSceneBase<SceneNaviTbtViewBinding, SceneNaviTbtImpl> {
    ...
    protected void initObserver() {
        ...
        mLength = context.getResources().
                getDimensionPixelSize(com.sgm.navi.ui.R.dimen.navi_tbt_with);
    }
    ...
    public void onCrossImageInfo(boolean isRealNeedShow) {
        ...
        if (!mIsCrossImageShow) {
            ...
            final int shortHeight = context.getResources().
                    getDimensionPixelSize(com.sgm.navi.ui.R.dimen.navi_tbt_height_short);
        ...
        ThreadManager.getInstance().postUi(new Runnable() {
            ...
            public void run() {
                ...
                final int normalHeight = context.getResources().
                        getDimensionPixelSize(com.sgm.navi.ui.R.dimen.navi_tbt_height);
