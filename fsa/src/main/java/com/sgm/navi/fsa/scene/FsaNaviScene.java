package com.sgm.navi.fsa.scene;
...
import com.sgm.navi.fsa.bean.CameraInfo;
import com.sgm.navi.fsa.bean.ChargingStationInfo;
import com.sgm.navi.fsa.bean.CurrentCarLocation;
import com.sgm.navi.fsa.bean.DestInfo;
import com.sgm.navi.fsa.bean.EnlargeMap;
import com.sgm.navi.fsa.bean.ForwardCameraInfo;
import com.sgm.navi.fsa.bean.GasStationInfo;
import com.sgm.navi.fsa.bean.GeoPoint;
import com.sgm.navi.fsa.bean.HighWayEntranceInfo;
import com.sgm.navi.fsa.bean.HighWayExitInfo;
import com.sgm.navi.fsa.bean.HighWayServiceAreaInfo;
import com.sgm.navi.fsa.bean.HighwayInfo;
import com.sgm.navi.fsa.bean.HighwayService;
import com.sgm.navi.fsa.bean.HighwaySubscribeInfo;
import com.sgm.navi.fsa.bean.HighwayTotalInfo;
import com.sgm.navi.fsa.bean.HudVideInfo;
import com.sgm.navi.fsa.bean.JunctionViewInfo;
import com.sgm.navi.fsa.bean.LaneDirection;
import com.sgm.navi.fsa.bean.LaneInfo;
import com.sgm.navi.fsa.bean.LaneItem;
import com.sgm.navi.fsa.bean.LaneLineInfo;
import com.sgm.navi.fsa.bean.LaneTypeInfo;
import com.sgm.navi.fsa.bean.NaviIntervalSpeedInfo;
import com.sgm.navi.fsa.bean.ParkInfo;
import com.sgm.navi.fsa.bean.RemainInfo;
import com.sgm.navi.fsa.bean.RoadCondition;
import com.sgm.navi.fsa.bean.ServiceAreaInfo;
import com.sgm.navi.fsa.bean.SpeedLimitCruiseInfo;
import com.sgm.navi.fsa.bean.SpeedLimitSignData;
...
public final class FsaNaviScene {
    ...
    public void updateNavigationCameraInfo(final MyFsaService fsaService, final CameraInfoEntity cameraInfo) {
        ...
        if (FsaConstant.FsaCameraType.INTERVAL_VELOCITY_START == subType
            ...
            final com.sgm.navi.service.define.bean.GeoPoint geoPoint = cameraInfo.getCoord2D();
            if (null != geoPoint) {
