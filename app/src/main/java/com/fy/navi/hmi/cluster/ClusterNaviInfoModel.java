...
public class ClusterNaviInfoModel extends BaseModel<ClusterNaviInfoViewModel>  implements IGuidanceObserver,
        ImmersiveStatusScene.IImmersiveStatusCallBack, ISceneCallback, IRouteResultObserver {
    private static final String TAG = "ClusterNaviInfoModel";
    ...
    public void onCreate() {
        super.onCreate();
        ImmersiveStatusScene.getInstance().registerCallback("ClusterNaviInfoModel", this);
    ...
    @Override
    public void onAttachViewModel(ClusterNaviInfoViewModel baseViewModel) {
