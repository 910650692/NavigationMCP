...
/**
 * 仪表导航信息 BaseViewModel
 */
public class BaseClusterNaviInfoViewModel extends BaseViewModel<ClusterNaviInfoFragment, ClusterNaviInfoModel> implements ISceneRoutePreferenceCallBack {
    private static final String TAG = "BaseClusterNaviInfoViewModel";
...
//    public ObservableField<Boolean> naviRouteNameVisibility;//当前路名
    ...
    public BaseClusterNaviInfoViewModel(@NonNull Application application) {
        super(application);
...
//        naviRouteNameVisibility = new ObservableField<>(true);
    ...
    @Override
    protected ClusterNaviInfoModel initModel() {
        return new ClusterNaviInfoModel();
    }
