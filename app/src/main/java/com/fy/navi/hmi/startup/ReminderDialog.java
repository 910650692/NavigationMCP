...
public class ReminderDialog extends BaseFullScreenDialog<DialogUseReminderBinding> {
    protected ReminderDialog(Context context, IBaseDialogClickListener baseDialogClickListener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewBinding.reminderIndex.reminderTermsService.setOnClickListener(v -> {
