...
import com.fy.navi.hmi.cluster.ClusterNaviInfoViewModel;
 ...
 * 仪表上层导航信息Fragment
 */
public class ClusterNaviInfoFragment extends BaseFragment<FragmentClusterNaviInfoBinding, ClusterNaviInfoViewModel> {
    public static final String TAG = "ClusterNaviInfoFragment";

    /**
     * 添加 newInstance 方法
     */
    public static ClusterNaviInfoFragment newInstance() {
        return new ClusterNaviInfoFragment();
    }
    @Override
