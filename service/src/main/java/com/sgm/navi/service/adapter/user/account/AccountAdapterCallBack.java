...
public interface AccountAdapterCallBack {
     ...
     */
    void notifyCarltdCheckBindResult(int errCode, int taskId, CarCheckBindInfo result);
     ...
     */
    void notifyCarltdBindResult(int errCode, int taskId, CarCheckBindInfo result);
     ...
     */
    void notifyCarltdLoginResult(int errCode, int taskId, CarCheckBindInfo result);
     ...
     */
    void notifyCarltdCheckTokenResult(int errCode, int taskId, CarCheckBindInfo result);
     ...
     */
    void notifyCarltdQLoginResult(int errCode, int taskId, CarCheckBindInfo result);
     ...
     */
    void notifyCarltdUnBindResult(int errCode, int taskId, CarCheckBindInfo result);
     ...
     */
    void notifyCarltdAuthInfoResult(int errCode, int taskId, CarCheckBindInfo result);
}
