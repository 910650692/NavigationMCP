...
public interface ILayerApi {
    ...
    /*设置搜索结果POI的选中状态*/
    void selectSearchPoi(MapType mapTypeId, LayerPointItemType type, int index, boolean isSelected);
    ...
    void setCrossImageInfo(MapType mapTypeId, CrossImageInfo info);
