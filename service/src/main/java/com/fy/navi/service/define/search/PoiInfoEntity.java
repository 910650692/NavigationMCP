...
public class PoiInfoEntity implements Parcelable {
    ...
    public String toString() {
        return "PoiInfoEntity{" +
                ...
                ", mBusinessTime='" + mBusinessTime + '\'' +
                ", mRatio=" + mRatio +
                ", mOpenStatus='" + mOpenStatus + '\'' +
                ", mHisMark=" + mHisMark +
                ", mScenicMark='" + mScenicMark + '\'' +
                ", mAverageCost=" + mAverageCost +
                ", mRating='" + mRating + '\'' +
                ", mImageUrl='" + mImageUrl + '\'' +
                ", mPoint=" + mPoint +
                ", mPointTypeCode='" + mPointTypeCode + '\'' +
                ", mIndustry='" + mIndustry + '\'' +
                ", mIsVisible=" + mIsVisible +
                ", mChildType=" + mChildType +
                ", mIsLocres=" + mIsLocres +
                ", mSortDistance=" + mSortDistance +
                ", mSortRate=" + mSortRate +
                ", mSortPrice=" + mSortPrice +
                ", mOperatorId='" + mOperatorId + '\'' +
                ", mStationId='" + mStationId + '\'' +
                ", mStationName='" + mStationName + '\'' +
                ", mStationTel='" + mStationTel + '\'' +
                ", mStationAddress='" + mStationAddress + '\'' +
                ", mStationBusinessTime='" + mStationBusinessTime + '\'' +
                ", mPictures=" + mPictures +
                ", mIsCollect=" + mIsCollect +
                ", mReservationInfo=" + mReservationInfo +
                ", mCityInfo=" + mCityInfo +
                ", mFavoriteInfo=" + mFavoriteInfo +
                ", mRetainParam=" + mRetainParam +
                ", mServiceAreaInfoList=" + mServiceAreaInfoList +
                ", mParkingInfoList=" + mParkingInfoList +
                ", mChargeInfoList=" + mChargeInfoList +
                ", mStationList=" + mStationList +
                ", mChildInfoList=" + mChildInfoList +
                ", mPoiAoiBounds=" + mPoiAoiBounds +
                ", mRoadPolygonBounds=" + mRoadPolygonBounds +
                ", mLableList=" + mLableList +
