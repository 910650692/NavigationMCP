...
final public class RoutePackage implements RouteResultObserver, QueryRestrictedObserver {
    ...
    private Map<MapTypeId, RouteParam> mStartRouteParams;
    private Map<MapTypeId, List<RouteParam>> mViaRouteParams;
    private Map<MapTypeId, List<RouteParam>> mSaveViaRouteParams;
    private Map<MapTypeId, RouteParam> mEndRouteParams;
    private Map<MapTypeId, RouteParam> mSaveEndRouteParams;
    ...
    @Getter
    private Map<MapTypeId, Integer> mSelectRouteIndex;
    private Map<MapTypeId, Long> mRequestId;

    public Map<MapTypeId, Integer> getSelectRouteIndex() {
     ...
     */
    private void callBackToSpeech(final MapTypeId mapTypeId) {
    ...
    public void onRouteFail(final RequestRouteResult requestRouteResult, final int errorCode, final String errorMsg) {
        ...
        for (IRouteResultObserver routeResultObserver : mRouteResultObserverMap.values()) {
            ...
            routeResultObserver.onRouteFail(requestRouteResult.getMMapTypeId(), errorMsg);
     ...
     */
    private void savePointAndCallBack(final MapTypeId mapTypeId, final List<RouteParam> routeParams) {
    ...
    public void onDrawRestrictionAndDetails(final RouteRestrictionParam param) {
        ...
        final RouteRestrictionParam routeRestrictionParam = mRequestRouteResults.get(MapTypeId.MAIN_SCREEN_MAIN_MAP).getMRouteRestrictionParam();
     ...
     * @return 返回请求的taskId
     */
    public long requestManyVia(final MapTypeId mapTypeId, final List<RouteParam> routeParams){
     ...
     * @return 返回请求taskId
     */
    public long requestChangeEnd(final MapTypeId mapTypeId, final PoiInfoEntity poiInfoEntity){
     ...
     */
    public void addViaPoint(final MapTypeId mapTypeId, final PoiInfoEntity poiInfoEntity) {
     ...
     * @return 返回是否成功
     */
    public boolean removeVia(final MapTypeId mapTypeId, final PoiInfoEntity poiInfoEntity, final boolean isRequestRoute) {
        final List<RouteParam> routeParams = mViaRouteParams.get(mapTypeId);
    ...
    public void requestRouteRestoration(final RouteMsgPushInfo routeMsgPushInfo, final MapTypeId mapTypeId) {
        ...
        if (ConvertUtils.isEmpty(paramList)) {
            return ;
        }
     ...
     * @return 返回请求的taskId
     */
    public long requestRouteWeather(final MapTypeId mapTypeId, final int index) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return -1;
        }
     ...
     * @return 返回请求的taskId
     */
    public long requestRouteAlternativeChargeStation(final MapTypeId mapTypeId, final String poiId) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return -1;
        }
     ...
     * @return 返回请求的taskId
     */
    public long requestRestirction(final MapTypeId mapTypeId) {
     ...
     * @param mapTypeId 屏幕id
     */
    private void clearVai(final MapTypeId mapTypeId) {
     ...
     * @return 返回是否
     */
    public boolean isBelongRouteParam(final MapTypeId mapTypeId, final PoiInfoEntity poiInfoEntity) {
     ...
     * @return 返回是否是起点&终点
     */
    public boolean isStartOrEndRouteParam(final MapTypeId mapTypeId, final PoiInfoEntity poiInfoEntity) {
        final List<RouteParam> allPoiParamList = getAllPoiParamList(mapTypeId);
        for (RouteParam routeParam : allPoiParamList) {
            if (isTheSamePoi(routeParam, poiInfoEntity)) {
     ...
     * @return 返回是否是起点&终点
     */
    public boolean isMaxRouteParam(final MapTypeId mapTypeId) {
        final List<RouteParam> allPoiParamList = getAllPoiParamList(mapTypeId);
     ...
     * @param mapTypeId 屏幕ID
     */
    public void showRouteLine(final MapTypeId mapTypeId) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return;
        }
     ...
     * @param mapTypeId 屏幕ID
     */
    public void clearRouteLine(final MapTypeId mapTypeId) {
        mNaviStatusAdapter.setNaviStatus(NaviStatus.NaviStatusType.NO_STATUS);
     ...
     * @param mapTypeId 屏幕ID
     */
    public void showPreview(final MapTypeId mapTypeId) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return;
        }
        final RouteLineLayerParam routeLineLayerParam = mRequestRouteResults.get(mapTypeId).getMLineLayerParam();
     ...
     * @param mapTypeId 屏幕ID
     */
    public void naviShowPreview(final MapTypeId mapTypeId) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return;
        }
        final RouteLineLayerParam routeLineLayerParam = mRequestRouteResults.get(mapTypeId).getMLineLayerParam();
     ...
     */
    public void selectRoute(final MapTypeId mapTypeId, final int routeIndex) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return;
        }
     ...
     * @param index 路线
     */
    public void showRestArea(final MapTypeId mapTypeId, final int index) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return;
        }
     ...
     * @param mapTypeId 屏幕ID
     */
    public void clearRestArea(final MapTypeId mapTypeId) {
     ...
     * @param mapTypeId 屏幕ID
     */
    public void showWeatherView(final MapTypeId mapTypeId) {
        if (ConvertUtils.isEmpty(mRequestRouteResults.get(mapTypeId))) {
            return;
        }
     ...
     * @param mapTypeId 屏幕ID
     */
    public void clearWeatherView(final MapTypeId mapTypeId) {
     ...
     * @param object 限行数据
     */
    public void showRestrictionView(final MapTypeId mapTypeId, final Object object) {
     ...
     * @param mapTypeId 屏幕ID
     */
    public void clearRestrictionView(final MapTypeId mapTypeId) {
     ...
     */
    public void updateViaParamList(final MapTypeId mapTypeId, final List<RouteParam> routeParams) {
        mViaRouteParams.put(mapTypeId, routeParams);
    }
    /**
     * 获取所有点的信息
     ...
     * @return 返回所有点的信息
     */
    private List<RouteParam> getParamList(final MapTypeId mapTypeId, final RouteParam routeParam) {
     ...
     * @param mapTypeId 屏幕Id
     */
    private void updateParamList(final MapTypeId mapTypeId) {
     ...
     * @param mapTypeId 屏幕Id
     */
    private void reGetParamList(final MapTypeId mapTypeId) {
     ...
     * @return 当前算路数据
     */
    private List<RouteParam> getCurrentParamsList(final MapTypeId mapTypeId) {
     ...
     * @param mapTypeId 屏幕Id
     */
    public void removeAllRouteInfo(final MapTypeId mapTypeId) {
     ...
     * @return 返回终点信息
     */
    public RouteParam getEndPoint(final MapTypeId mapTypeId) {
     ...
     * @return 算路信息
     */
    public RouteCurrentPathParam getCurrentPathInfo(final MapTypeId mapTypeId) {
     ...
     */
    public void drawRestrictionForLimit(final MapTypeId mapTypeId, final Object param, final int position) {
        mLayerAdapter.showRestrictionView(mapTypeId, null);
     ...
     * @return 途径点个数
     */
    public int getViaPointsCount(final MapTypeId mapTypeId) {
     ...
     * @param mapTypeId 屏幕ID
     */
    public void abortRequest(final MapTypeId mapTypeId) {
