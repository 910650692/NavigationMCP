...
public class VectorCrossBean {
    ...
    public static class VectorCrossLayerStyleBean {
        ...
        public static class VectorCrossMarkerBean {
            ...
            public String toString() {
                return "VectorCrossMarkerBean{" +
                        "bg_marker_id='" + bg_marker_id + '\'' +
                        ", bg_marker_info='" + bg_marker_info + '\'' +
                        ", arrow_outer_marker_id='" + arrow_outer_marker_id + '\'' +
                        ", arrow_inner_marker_id='" + arrow_inner_marker_id + '\'' +
                        ", car_marker_id='" + car_marker_id + '\'' +
                        '}';
            }
        }
        ...
        public static class VectorCrossAttrBean {
            ...
            public static class ArrowLineCapTextureBean {
                ...
                @Override
                public String toString() {
                    return "ArrowLineCapTextureBean{" +
                            "x1=" + x1 +
                            ", x2=" + x2 +
                            ", y1=" + y1 +
                            ", y2=" + y2 +
            ...
            public static class ArrowHeaderCapTextureBean {
                ...
                @Override
                public String toString() {
                    return "ArrowHeaderCapTextureBean{" +
                            "x1=" + x1 +
                            ", x2=" + x2 +
                            ", y1=" + y1 +
                            ", y2=" + y2 +
            ...
            @Override
            public String toString() {
                return "VectorCrossAttrBean{" +
                        "day_mode=" + day_mode +
                        ", arrow_border_width=" + arrow_border_width +
                        ", arrow_line_width=" + arrow_line_width +
                        ", area_color=" + area_color +
                        ", arrow_border_color=" + arrow_border_color +
                        ", arrow_line_color=" + arrow_line_color +
                        ", arrow_line_cap_texture=" + arrow_line_cap_texture +
                        ", arrow_header_cap_texture=" + arrow_header_cap_texture +
                        ", arrow_line_texture=" + arrow_line_texture +
                        ", rect=" + rect +
                        '}';
            }
        }
        ...
        @Override
        public String toString() {
            return "VectorCrossLayerStyleBean{" +
                    "vector_cross_marker=" + vector_cross_marker +
                    ", vector_cross_attr=" + vector_cross_attr +
                    '}';
        }
    }
    ...
    public String toString() {
        return "VectorCrossBean{" +
                "vector_cross_layer_style=" + vector_cross_layer_style +
                '}';
    }
}
