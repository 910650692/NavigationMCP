...
/**
 * 矢量路口大图json配置实体类
 * 注：目前的变量命名是和gbl_inner_style_1.json里的字段一一对应
 */
public class CarTypeBean {
    ...
    public static class CcarLayerStyle {
        ...
        public static class CarMarker {
            ...
            public String toString() {
                return "CarMarker{" +
                        "compass_marker_id='" + compass_marker_id + '\'' +
                        ", compass_indicator_marker_id='" + compass_indicator_marker_id + '\'' +
                        ", track_marker_id='" + track_marker_id + '\'' +
                        ", track_arc_marker_id='" + track_arc_marker_id + '\'' +
                        ", shine_marker_id='" + shine_marker_id + '\'' +
                        '}';
            }
        }
        ...
        public static class CompassMarkerInfo {
            ...
            @Override
            public String toString() {
                return "CompassMarkerInfo{" +
                        "east_marker_id='" + east_marker_id + '\'' +
                        ", south_marker_id='" + south_marker_id + '\'' +
                        ", west_marker_id='" + west_marker_id + '\'' +
                        ", north_marker_id='" + north_marker_id + '\'' +
        ...
        @Override
        public String toString() {
            return "CcarLayerStyle{" +
                    "car_marker=" + car_marker +
                    ", compass_marker_info=" + compass_marker_info +
                    ", car_animation_style=" + car_animation_style +
                    '}';
        }
    }
    ...
    public String toString() {
        return "CarTypeBean{" +
                "car_layer_style=" + car_layer_style +
                '}';
    }
}
