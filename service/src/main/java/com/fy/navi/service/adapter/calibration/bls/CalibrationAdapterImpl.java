...
public class CalibrationAdapterImpl implements CalibrationApi {
    ...
    public int brand() {
        ...
        Logger.d(TAG, "s GMBrand: " + integer);
        return integer;
    }
    ...
    public int model() {
        ...
        Logger.d(TAG, "s GMModel: " + integer);
        return integer;
    }
    ...
    public boolean enableApplicationNavigation() {
        ...
        Logger.d(TAG, "s ENABLE_APPLICATION_NAVIGATION: " + enable);
        return enable;
    }
    ...
    public boolean laneLevelNavigatioFuncEnable() {
        ...
        Logger.d(TAG, "s P_LaneLevelNavigation_Func_Enable: " + enable);
        return enable;
    }
    ...
    public boolean v2xMapDisplayFuncEnable() {
        ...
        Logger.d(TAG, "s P_V2XMapDisplay_Func_Enable: " + enable);
        return enable;
    }
    ...
    public int speedLimitInformationSource() {
        ...
        Logger.d(TAG, "s P_SpeedLimitInformationSource: " + integer);
        return integer;
    }
    ...
    public int adasConfigurationInfomation() {
        ...
        Logger.d(TAG, "s P_ADAS_Configuration_Infomation: " + integer);
        return integer;
    }
    ...
    public int adasConfigurationType() {
        ...
        Logger.d(TAG, "s ADAS_Configuration_Type: " + integer);
        return integer;
    }
    ...
    public boolean rearSeatTouchPanelFuncEnable() {
        ...
        Logger.d(TAG, "s P_RearSeatTouchPanel_Func_Enable: " + enable);
        return enable;
    }
    ...
    public int hudFuncEnable() {
        ...
        Logger.d(TAG, "s P_HUD_Func_Enable: " + integer);
        return integer;
    }
    ...
    public boolean navigationDeflectionEnable() {
        ...
        Logger.d(TAG, "s P_Navigation_Deflection_Enable: " + enable);
        return enable;
    }
    ...
    public int architecture() {
        ...
        Logger.d(TAG, "s P_ARCHITECTURE: " + integer);
        return integer;
    }
    ...
    public boolean navigationPreConditionDataProvideEnable() {
        ...
        Logger.d(TAG, "s P_Navigation_PreCondition_DataProvide_Enable: " + enable);
        return enable;
    }
    ...
    public int navigaitonSupplier() {
        ...
        Logger.d(TAG, "s P_Navigaiton_Supplier: " + integer);
        return integer;
    }
    ...
    public int highVoltageBatteryPropulsionTotalRangeNavi() {
        ...
        Logger.d(TAG, "s P_High_Voltage_Battery_Propulsion_Total_Range_Navi: " + integer);
        return integer;
    }
    ...
    public boolean poiSearchFuncEnable() {
        ...
        Logger.d(TAG, "s P_POISearch_Func_Enable: " + enable);
        return enable;
    }
    ...
    public boolean scenarioEngineFuncEnable() {
        ...
        Logger.d(TAG, "s P_ScenarioEngine_Func_Enable: " + enable);
        return enable;
    }
    ...
    public boolean globalSearchFuncEnable() {
        ...
        Logger.d(TAG, "s P_GlobalSearch_Func_Enable: " + enable);
        return enable;
    }
    ...
    public boolean teamTravelFuncEnable() {
        ...
        Logger.d(TAG, "s P_TeamTravel_Func_Enable: " + enable);
        return enable;
    }
    ...
    public boolean bootAnimationReplacementFuncEnable() {
        ...
        Logger.d(TAG, "s P_BootAnimationReplacement_Func_Enable: " + enable);
        return enable;
    }
    ...
    public boolean imeFuncEnable() {
        ...
        Logger.d(TAG, "s P_IME_Func_Enable: " + enable);
        return enable;
    }
    ...
    public boolean wallpaperThemeFuncEnable() {
        ...
        Logger.d(TAG, "s P_Wallpaper_Theme_Func_Enable: " + enable);
        return enable;
    }
    ...
    public int themeDefaultValue() {
        ...
        Logger.d(TAG, "s P_THEME_DEFAULT_VALUE: " + integer);
        return integer;
    }
    ...
    public float[] slopeUpCostlist() {
        ...
        Logger.d(TAG, "s SLOPE_UP_COSTLIST: " + Arrays.toString(array));
        return array;
    }
    ...
    public float[] slopeDownCostlist() {
        ...
        Logger.d(TAG, "s SLOPE_DOWN_COSTLIST: " + Arrays.toString(array));
        return array;
    }
    ...
    public float[] transAccessCostlist() {
        ...
        Logger.d(TAG, "s TRANS_ACCESS_COSTLIST: " + Arrays.toString(array));
        return array;
    }
    ...
    public float[] transDecessCostlist() {
        ...
        Logger.d(TAG, "s TRANS_DECESS_COSTLIST: " + Arrays.toString(array));
        return array;
    }
    ...
    public Map<Integer, Float> speedCostlist() {
        ...
        Logger.d(TAG, "s SPEED_COSTLIST: " + map);
        return map;
    }
    ...
    public float[] auxCostlist() {
        ...
        Logger.d(TAG, "s AUX_COSTLIST: " + Arrays.toString(array));
        return array;
    }
    ...
    public int vehicleWeight() {
        ...
        Logger.d(TAG, "s VEHICLE_WEIGHT: " + integer);
        return integer;
    }
}
